...
// URLs e chave de API
const API_URL = process.env.API_URL || "http://api:3001/test";
...
router.post("/generate-report", upload.single("image"), async (req: Request, res: Response) => {
    ...
    try {
        ...
        const data = {
            ...
            messages: [
                { role: "system", content: "Você é um especialista em laudos de imagens para pessoas com deficiência visual." },
